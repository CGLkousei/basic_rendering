...
Camera::Camera()
        : m_EyePoint(Eigen::Vector3d::Zero()), m_xVector(Eigen::Vector3d{1.0, 0.0, 0.0}),
          m_yVector(Eigen::Vector3d{0.0, 1.0, 0.0}), m_zVector(Eigen::Vector3d{0.0, 0.0, 1.0}), m_DistanceToObject(1.0),
          m_FocalLength(0.035), m_ScreenWidth(0.036), m_ScreenHeight(0.024) {
